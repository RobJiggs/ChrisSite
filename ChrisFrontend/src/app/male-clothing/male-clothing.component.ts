...
@Component({
  selector: 'app-male-clothing',
  templateUrl: './male-clothing.component.html',
  styleUrls: ['./male-clothing.component.css']
})
export class MaleClothingComponent {
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      if (dateadded) {
        ...
        this.searchItems('Male', undefined, undefined, undefined, undefined, undefined, dateadded, undefined)
      }
        ...
        this.searchItems('Male', category, undefined, undefined, undefined, undefined, undefined, undefined)
      } else {
        // Handle the case when there are no 'dateadded' or 'category' parameters
        this.searchItems('Male', undefined, undefined, undefined, undefined, undefined, undefined, undefined);
      }
    });
  ...
  searchItems(
    ...
    this.signupService.searchItems(
      ...
      data => {
        ...
        if (data.length === 0 && sex === 'Male' && category === undefined && dateAdded !== undefined) {
          this.searchItems('Male', undefined, undefined, undefined, undefined, undefined, undefined, undefined);
